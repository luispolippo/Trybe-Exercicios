...
describe('Rota /api/users', () => {
  ...
  describe('Consulta a lista de pessoas usuárias', () => {
    ...
    it(
        'A requisicao GET para a rota traz uma lista inicial' +
    ...
    it('Essa requisicao deve retornar código de status 200', () => {
  ...
  describe('Insere novo registro', () => {
    ...
    it('firstUserList: A primeira requisiçao GET para a rota deve retornar 2 registros', () => {
    ...
    it('createRequest: A requisiçao deve retornar um objeto no corpo da resposta', () => {
    ...
    it('secondUserList: A segunda requisiçao GET para a rota deve retornar 3 registros', () => {
      expect(secondUserList).to.have.length(3);
    });

    it('secondUserList: O regsitro criado deve corresponder ao enviado na requisição POST', () => {
